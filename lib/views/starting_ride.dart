...
class StartingRide extends StatefulWidget {
  const StartingRide({super.key});

  @override
  State<StartingRide> createState() => _StartingRideState();
}

class _StartingRideState extends State<StartingRide> {
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          DriverInfo(state: 'Arriving in 5 minuets',),
        ],
      ),
    );
  }
